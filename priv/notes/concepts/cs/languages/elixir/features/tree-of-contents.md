...
- [**`%Slug{}` (_abbreviated_)** - _represents an actual link to a markdown file_](https://github.com/marka2g/marksmarkdown/blob/main/lib/marks_down/directories/slug.ex){:target="_blank"}{:css #slug-code-link .under}
>```elixir
