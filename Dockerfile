...
# this file was generated by the fly launch command but a good fly resource is here: https://github.com/fly-apps/hello_elixir/blob/main/Dockerfile
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/marks_down ./
